...
**A note specific to this project:** because 911_4D deals directly with
the deaths of thousands of people, contributors are also expected to
follow the language and content guidelines in
[`docs/ethics.md`](docs/ethics.md) — neutral, precise, non-sensational
language about the event, no editorializing about victims or
perpetrators, and no use of the event as rhetorical device or metaphor.
Violations of those guidelines in project spaces (commits, issues, PRs,
discussions) are handled under this Code of Conduct.
...
**[CONTACT EMAIL PLACEHOLDER — to be filled in by a project maintainer]**.
